...
func (*UploadPhotoFileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{0}
}
...
func (*GetPhotoFileDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{1}
}
...
func (*PhotoDataRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{2}
}
...
func (*NbfsUploadedPhotoMedia) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{3}
}
...
func (*NbfsUploadedDocumentMedia) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{4}
}
...
func (*DocumentId) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{5}
}
...
func (*DocumentAttributeList) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{6}
}
...
func (*DocumentIdList) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{7}
}
...
func (*DocumentList) Descriptor() ([]byte, []int) {
	return fileDescriptor_nbfs_service_2ef303adaf533a52, []int{8}
}
...
func init() { proto.RegisterFile("nbfs_service.proto", fileDescriptor_nbfs_service_2ef303adaf533a52) }

var fileDescriptor_nbfs_service_2ef303adaf533a52 = []byte{
