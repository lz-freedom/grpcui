	...
	if name, ok := TLRpcErrorCodes_name[int32(code)]; ok {
		if code <= TLRpcErrorCodes_OTHER2 {
			...
			case TLRpcErrorCodes_FLOOD_WAIT_X:
				...
				glog.Error(err)
			case TLRpcErrorCodes_USER_NOT_EXISTS,
				TLRpcErrorCodes_TEAM_NOT_EXISTS,
				TLRpcErrorCodes_TEAM_EXPEL_USER_CAN_NOT_EXPEL_YOURSELF_CODE,
				TLRpcErrorCodes_TEAM_EXPEL_USER_USER_NOT_IN_TEAM_CODE,
				TLRpcErrorCodes_TEAM_EXPEL_USER_ADMIN_CAN_NOT_EXPEL_ADMIN_AND_OWNER_CODE,
				TLRpcErrorCodes_TEAM_EXPEL_USER_NOT_ADMIN_CODE,
				TLRpcErrorCodes_TEAM_INVITE_JOIN_INVITEES_NOT_EXISTS_CODE,
				TLRpcErrorCodes_TEAM_INVITE_JOIN_ALREADY_IN_TEAM_CODE,
				TLRpcErrorCodes_TEAM_JOIN_ALREADY_IN_TEAM_CODE,
				TLRpcErrorCodes_TEAM_QUIT_NOT_IN_TEAM_CODE,
				TLRpcErrorCodes_TEAM_UPDATE_NOT_PERMISSION_CODE,
				TLRpcErrorCodes_TEAM_UPDATE_HANDOVER_PERSON_NOT_IN_TEAM_CODE:
				err = &TLRpcError{Data2: &RpcError_Data{
					ErrorCode:    int32(code),
					ErrorMessage: name,
				}}
